...
namespace GamersChat.Data.Migrations
{
    ...
    [Migration("20230618103222_pqowrk")]
    partial class pqowrk
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamersChat.Models.Follow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GamersChat.Models.Follow", b =>
                {
                    b.HasOne("GamersChat.Models.ApplicationUser", "FollowedUser")
                        .WithMany()
                        .HasForeignKey("FollowedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GamersChat.Models.ApplicationUser", "Follower")
                        .WithMany()
